...
void geometry_domain_create_gpu(domain* dom, int nx, int ny, int nz,
                                double lx, double ly, double lz,
                                double ox, double oy, double oz,
                                double ax, double ay, double az,
                                int is_periodic[3]);

void geometry_domain_destroy_gpu(domain* dom);
...
void geometry_subdomain_ddt_create(subdomain *sdm);
void geometry_subdomain_ddt_destroy(subdomain *sdm);
void geometry_halocell_update_selectively_gpu(double *u, subdomain *sdm, int *is_serial);
#ifdef __cplusplus
}
#endif
